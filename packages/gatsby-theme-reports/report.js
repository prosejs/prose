...
const entityName = 'Report' // TODO: make option?
...
module.exports = listDetailDefinitions({
  ...
  list: listBasic({
    path: '/',
    listComponent: require.resolve(`./src/templates/reports-query`),
  }),
  detail: detailNextPrevious({
    detailComponent: require.resolve(`./src/templates/report-query`),
  }),
})
